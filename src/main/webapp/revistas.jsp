...
<html>
    ...
    <body style="background-color: white">
        ...
        <div class="container">
            ...
            %>
            <%
                LibrosDAO libroRevistaDAO = new LibrosDAO();
                List<Map<String, Object>> resultados = libroRevistaDAO.obtenerInfoPrestamos(2);
                int contador;
            ...
            <div class="card" style="width: 18rem; margin-top: 80px;display: inline-flex;margin-left: 20px;margin-right: 20px;border: 1px solid black ">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">autor: <%= fila.get("AUTOR") %></li>
                    <li class="list-group-item">Editorial: <%= fila.get("EDITORIAL") %></li>
