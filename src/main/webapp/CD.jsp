...
<html>
    ...
    <body style="background-color: white">
        ...
        <div class="container">
            ...
            %>
            <%
                List<Map<String, Object>> resultados = MultimediaDAO.obtenerInfoPrestamos(1);
                int contador;
            ...
            <div class="card" style="width: 18rem; margin-top: 80px;display: inline-flex;margin-left: 20px;margin-right: 20px;">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">Artista: <%= fila.get("ARTISTA") %></li>
                ...
                <div class="card-body">
                    <a href="Principal.jsp" class="card-link">Ver mas a detalle</a>
